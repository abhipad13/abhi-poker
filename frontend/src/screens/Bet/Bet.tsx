...
export default function Bet({ gameId, playerName }: { gameId: string; playerName: string }) {
  ...
  return (
    <div className="min-h-screen bg-[#0b6b3a] flex items-center justify-center p-6"
         style={{
           backgroundImage: `
      ...
      <div className="w-full max-w-[1000px] bg-black/45 border border-white/12 rounded-[18px] shadow-2xl backdrop-blur-sm p-6 relative overflow-hidden">
        ...
        <div className="flex justify-around items-end my-5 min-h-[200px] px-5">
             ...
             <div className="text-xs text-white/75 font-semibold">${chipDenoms[1]}</div>
          ...
          <div className="flex flex-col items-center gap-2">
            <div className="text-xs text-white/75 font-semibold">${chipDenoms[5]}</div>
            <div className="relative h-[140px] w-[70px] grid place-items-center cursor-pointer" 
                 onClick={() => {
          ...
          <div className="flex flex-col items-center gap-2">
            <div className="text-xs text-white/75 font-semibold">${chipDenoms[25]}</div>
            <div className="relative h-[140px] w-[70px] grid place-items-center cursor-pointer" 
                 onClick={() => {
          ...
          <div className="flex flex-col items-center gap-2">
            <div className="text-xs text-white/75 font-semibold">${chipDenoms[100]}</div>
            <div className="relative h-[140px] w-[70px] grid place-items-center cursor-pointer" 
                 onClick={() => {
          ...
          <div className="flex flex-col items-center gap-2">
            <div className="text-xs text-white/75 font-semibold">${chipDenoms[500]}</div>
            <div className="relative h-[140px] w-[70px] grid place-items-center cursor-pointer" 
                 onClick={() => {
